...
// AUTO-GENERATED. Do not edit by hand. Source of truth lives in the
// EVtivity website repo at app/data/error-codes.json.
...
export const ERROR_CODES = {
  ...
  MAINTENANCE_INVALID_RANGE: 'MAINTENANCE_INVALID_RANGE',
  MAINTENANCE_NOT_FOUND: 'MAINTENANCE_NOT_FOUND',
  MAINTENANCE_OVERLAPS_EXISTING: 'MAINTENANCE_OVERLAPS_EXISTING',
  ...
  RESERVATION_DURING_MAINTENANCE: 'RESERVATION_DURING_MAINTENANCE',
  ...
  STATION_ALREADY_AVAILABLE: 'STATION_ALREADY_AVAILABLE',
  STATION_ALREADY_IN_FLEET: 'STATION_ALREADY_IN_FLEET',
...
export type ErrorCode =
  ...
  | 'SSO_DISABLED'
  | 'START_REJECTED'
  | 'STATION_ALREADY_AVAILABLE'
  | 'STATION_ALREADY_IN_FLEET'
  | 'STATION_ID_EXISTS'
  | 'STATION_NOT_FOUND'
  | 'STATION_OFFLINE'
  | 'STATION_REJECTED'
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  MAINTENANCE_NOT_FOUND: 'Maintenance event not found',
  MAINTENANCE_OVERLAPS_EXISTING: 'Maintenance window overlaps an existing event',
  ...
  RESERVATION_DURING_MAINTENANCE: 'Reservation falls within a scheduled maintenance window',
  ...
  STATION_ALREADY_AVAILABLE: 'Station already has an available connector',
  STATION_ALREADY_IN_FLEET: 'Station is already in this fleet',
  ...
  STORAGE_CONNECTION_FAILED: 'Storage connection test failed',
  STORAGE_NOT_CONFIGURED: 'Attachment storage not configured',
  ...
  TOO_MANY_WATCHES: 'You are watching too many stations',
