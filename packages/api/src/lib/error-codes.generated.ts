...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  STORAGE_CONNECTION_FAILED: 'S3 connection test failed',
  ...
  EMAIL_NOT_CONFIGURED: 'SMTP not configured',
  ...
  PAYMENT_PROVIDER_CONNECTION_FAILED: 'Stripe connection test failed',
  PAYMENT_TOP_UP_FAILED: 'Stripe rejected the top-up payment intent',
  ...
  SMS_NOT_CONFIGURED: 'Twilio not configured',
  UNAUTHORIZED: 'Unauthorized',
