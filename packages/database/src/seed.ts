...
async function seed(): Promise<void> {
  ...
  // Animated variant: ring spins once every 10s, bolt pulses darker with a soft glow every 5s.
  // Used for company.logo only; the favicon stays static because most browsers do not animate SVG favicons.
