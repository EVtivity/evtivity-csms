...
export const TC_B_27_CSMS: TestCase = {
  ...
  sut: 'csms',
  description:
    'This test case covers how the CSMS can remotely request the Charging Station to reset an EVSE by sending a ResetRequest with type Immediate while a transaction is ongoing.',
  purpose:
  ...
  execute: async (ctx) => {
    ...
    steps.push({
      step: 1,
      description: 'CSMS sends ResetRequest for EVSE with type Immediate',
