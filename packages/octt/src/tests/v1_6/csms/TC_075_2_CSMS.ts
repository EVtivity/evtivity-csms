...
export const TC_075_2_CSMS: TestCase = {
  id: 'TC_075_2_CSMS',
  name: 'Install Certificate - CentralSystemRootCertificate (1.6)',
  module: 'security',
  version: 'ocpp1.6',
  sut: 'csms',
  description: 'Install a Central System root certificate on the Charge Point.',
  purpose: 'Verify the CSMS can send InstallCertificate with CentralSystemRootCertificate type.',
  execute: async (ctx) => {
    ...
    steps.push({
      step: 1,
      description: 'Receive InstallCertificate (CentralSystemRootCertificate) and respond Accepted',
